...
data:
  ...
  attribute: 0x0240
  attr_type: 0x48
  attr_val: [20, 0c, 00, 9f, 26, 00, 00, 4c, 55, 01, 00, 01, 00, 00, 00]
  read_before_write: true
  read_after_write: true
  use_cache: false
...
data:
  ...
  attribute: 0x0240
  attr_type: 0x48
  attr_val: [20, 0c, 00, 01, 00, 00, 00, 00, 00, 00, 00, 01, 00, 00, 00]
  read_before_write: true
  read_after_write: true
  use_cache: false
...
data:
  ...
  attribute: 0x0240
  attr_type: 0x48
  attr_val: [20, 0c, 00, 00, 00, 00, 00, 00, 00, 00, 00, 01, 00, 00, 00]
  read_before_write: true
  read_after_write: true
  use_cache: false
