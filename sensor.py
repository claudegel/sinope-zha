...
class SinopeManufacturerCluster(CustomCluster):
    ...
    attributes = {
        ...
        0x0030: ("unknown_1", t.uint8_t, True),
        0x0031: ("unknown_2", t.uint16_t, True),
        0x0032: ("unknown_3", t.int16s, True),
        0x0033: ("unknown_4", t.int16s, True),
        0x0034: ("unknown_5", t.bitmap8, True),
        0x0035: ("unknown_6", t.uint16_t, True),
        0x0036: ("unknown_7", t.uint16_t, True),
        0x0080: ("unknown_8", t.uint32_t, True),
